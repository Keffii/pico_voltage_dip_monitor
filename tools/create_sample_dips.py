...
def main():
    ...
    dips = [
        ...
        ('PLC', 5.123, 5.245, 122, 1.250, 1.080, 0.170),
        ('MODEM', 12.456, 12.589, 133, 1.270, 1.095, 0.175),
        ('BATTERY', 18.789, 18.920, 131, 1.290, 1.075, 0.215),
        ('PLC', 25.234, 25.389, 155, 1.250, 1.050, 0.200),
        ('MODEM', 32.567, 32.712, 145, 1.270, 1.090, 0.180),
    ]
