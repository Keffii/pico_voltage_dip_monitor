...
def test_single_channel_view_ignores_hidden_channel_dip_events_in_graph():
    ui = OledUI.__new__(OledUI)
...
def test_single_channel_view_ignores_hidden_channel_dip_events_in_stats():
    ui = OledUI.__new__(OledUI)
    ui.graph_channel_filter = "BLUE"
    ui.view_mode = "STATS"
    ui.negative_dip = False
    ui.sample_counter = 18
    ui.stats_max_events = 4
    ui.graph_max_events = 4
    ui.dip_events = []
    ui._stats_dirty = False
    ...
    ui.record_dip_event_adc("YELLOW", 12.0, 11.4, 0.6, event_id=4, active=False, sample_index=18)

    _assert(ui.dip_events == [], "Hidden-channel dip events should be ignored in single-channel view")
    _assert(ui._stats_dirty is False, "Ignoring a hidden-channel event should not dirty stats")


def test_single_channel_view_ignores_hidden_channel_dip_latches_in_graph():
    ui = OledUI.__new__(OledUI)
    ui.graph_channel_filter = "BLUE"
    ui.view_mode = "GRAPH"
    ui.negative_dip = False
    ...
    _assert(ui.min_drop_real_max is None, "Ignored hidden-channel latches should not update min-drop magnitude")


def test_single_channel_view_ignores_hidden_channel_dip_latches_in_stats():
    ui = OledUI.__new__(OledUI)
    ui.graph_channel_filter = "BLUE"
    ui.view_mode = "STATS"
    ui.negative_dip = False
...
def test_all_channel_view_keeps_cross_channel_dip_intake_for_records():
    ui = OledUI.__new__(OledUI)
...
def test_all_channel_view_keeps_cross_channel_dip_intake_for_latches():
    ui = OledUI.__new__(OledUI)
    ui.graph_channel_filter = "ALL"
    ui.view_mode = "STATS"
    ui.negative_dip = False
    ...
    _assert(ui.latched_dip["YELLOW"] == 0.9, "ALL mode should still accept cross-channel dip latches")
    _assert(ui.min_drop_channel == "YELLOW", "ALL mode should preserve the source channel for min-drop tracking")
...
def run_all():
    tests = (
        ...
        test_single_channel_view_ignores_hidden_channel_dip_events_in_graph,
        test_single_channel_view_ignores_hidden_channel_dip_events_in_stats,
        test_single_channel_view_ignores_hidden_channel_dip_latches_in_graph,
        test_single_channel_view_ignores_hidden_channel_dip_latches_in_stats,
        test_all_channel_view_keeps_cross_channel_dip_intake_for_records,
        test_all_channel_view_keeps_cross_channel_dip_intake_for_latches,
